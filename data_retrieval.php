...
<html lang="en" dir="ltr">
  <head>
    ...
    button{box-shadow: 0 1px 6px rgba(0, 0, 0, 0.12), 0 1px 4px rgba(0, 0, 0, 0.24);font-size: 18px;
      border: none;background-color: transparent;resize: none;outline: none;background-color: Blue;width:160px;height:40px;color:white;opacity: 0.8;
     clear:right;
    }
  ...
  <body>
    <h1>STUDENT DATA RETRIEVAL SYSTEM</h1>
    <form action="data_entry.php" method="post">
      ...
      <button type="submit" formaction="data_entry.php">Calculate Average Marks</button>
    </form>
   <br><br>
 ...
 if(name)
 {
   ...
   document.getElementById("m1").innerHTML="<td><b>Maths Marks</b></td><td>"+marks1+"</td>";
   document.getElementById("m2").innerHTML="<td><b>Hindi Marks</b></td><td>"+marks2+"</td>";
   document.getElementById("m3").innerHTML="<td><b>ENglish Marks</b></td><td>"+marks3+"</td>";
}
function avg()
{
